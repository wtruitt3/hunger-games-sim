...
class RobotVisualization:
    ...
    def _draw_robot(self, position, direction, robot):
        ...
        return self.w.create_text(x1, y1, text = robot.get_name(), fill="black")
    ...
    def update(self, room, robots):
        ...
        for robot in robots:
            ...
            self.robots.append(self.w.create_oval(x1, y1, x2, y2,
                                                  fill = "", outline = 'black'))
            self.robots.append(
                self._draw_robot(robot.get_position(), robot.get_direction(), robot))
        # Update text
